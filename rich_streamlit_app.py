...
def load_and_preprocess_data(file_path):
    ...
    selected_birthday = st.selectbox("Select a Birthday", unique_birthdays)
...
def main():
    ...
    if uploaded_file is not None:
        ...
        birthday_column = st.selectbox("Select the column for 'Birthday'", column_names)
        date_column = st.selectbox("Select the column for 'Date'", column_names)
        cust_id_column = st.selectbox("Select the column for 'Customer ID'", column_names)
        spend_column = st.selectbox("Select the column for 'Spend'", column_names)
